...
```
1. Create function that takes in variable n
2.Create a loop that runs while variable i is less than or equal to n
3.If the remainder of n divided by is equal to 0, print i
```
